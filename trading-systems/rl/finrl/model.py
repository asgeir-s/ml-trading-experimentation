...
class FinRLExperiment(Model):
    ...
    def generate_features(
        ...
        relative_input["high_rel"] = (candlesticks["high"] / candlesticks["open"] * 100) - 100
        relative_input["low_rel"] = (candlesticks["low"] / candlesticks["open"] * 100) - 100
        relative_input["close_rel"] = (candlesticks["close"] / candlesticks["open"] * 100) - 100
        # relative_input = (
        ...
        computed_features = computed_features.fillna(0)
